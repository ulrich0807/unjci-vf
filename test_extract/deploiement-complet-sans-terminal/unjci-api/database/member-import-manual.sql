-- Ancienne mise à niveau manuelle pour la base de production UNJCI.
-- La liste preloaded_members est obsolète et ne doit plus servir à valider un numéro UNJCI.
-- Ne pas importer preloaded-members-import.sql comme référentiel des membres.
